            ...
            <tr>
                <td>
                    <table class="nav-justified" style="height: 100px">
                        ...
                        <tr>
                            <td style="width: 150px; height: 48px"></td>
                            <td style="width: 60px; height: 48px">Name:</td>
                            <td class="modal-sm" style="width: 250px; height: 48px">
                                <asp:TextBox ID="FacultyName" runat="server" Width="238px" Height="40px"></asp:TextBox>
                            </td>
                            <td style="width: 60px; height: 48px">Dept</td>
                            <td class="modal-sm" style="width: 250px; height: 48px">
                                <asp:TextBox ID="Department" runat="server" Width="236px" Height="40px"></asp:TextBox>
                            </td>
                            <td style="width: 60px; height: 48px">Date:</td>
                            <td style="width: 250px; height: 48px">&nbsp;</td>
                            <td style="height: 48px"></td>
                        </tr>
                        <tr>
                            <td style="width: 150px; height: 48px">&nbsp;</td>
                            <td style="width: 60px; height: 48px">&nbsp;</td>
                            <td class="modal-sm" style="width: 250px; height: 48px">
                                <table class="nav-justified" style="height: 150px">
                                    <tr>
                            ...
                            <td style="width: 60px; height: 48px">&nbsp;</td>
                            <td class="modal-sm" style="width: 250px; height: 48px">&nbsp;</td>
                            <td style="width: 60px; height: 48px">&nbsp;</td>
                            <td style="width: 250px; height: 48px">
