<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MortgageCalculator.aspx.cs" Inherits="WebApplicationMasterProject.Demos.MortgageCalculator.MortgageCalculator" %>
...
<tr>
<td style="width: 386px" class="modal-sm">Purchase Price:</td>
<td>
    <asp:TextBox ID="PurchasePriceTB" runat="server" Width="250px"></asp:TextBox>
</td>
</tr>
    <tr>
        <td class="modal-sm" style="width: 386px">Loan Amount<span style="color: #FF0000"><strong>*</strong></span>:</td>
        <td>
            <asp:TextBox ID="LoanAmount" runat="server" MaxLength="7" TextMode="Number" Width="250px"></asp:TextBox>
