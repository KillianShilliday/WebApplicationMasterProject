<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MortgageApplicationXML.aspx.cs" Inherits="CIS325_Master_Project.Demos.MortgageApplicationXML.MortgageApplicationXML" %>
    ...
    <asp:Panel ID="DataFormPanel" runat="server">
        <table style="width: 2507px; height: 146px; ">
            ...
            <tr style="font-size: x-large">
                ...
                <td style="width: 814px; font-size: large"><asp:TextBox ID="CustomerSSN" runat="server"  Width="530px"></asp:TextBox></td>
            </tr>

            <tr style="font-size: x-large">
                <td style="font-size: large; width: 297px;">Customer Annual Income:</td>
                <td style="width: 814px; font-size: large"><asp:TextBox ID="CustomerIncome" runat="server"  Width="530px"></asp:TextBox></td>
            </tr>

            <tr style="font-size: x-large">
                <td style="font-size: large; width: 297px;">First Time Home Buyer:</td>
                <td style="width: 814px; font-size: large">
                    <asp:RadioButtonList ID="CustomerFirstTime" runat="server">
            ...
            <tr style="font-size: x-large">
                <td style="font-size: large; width: 297px;">Customer Gender:</td>
                <td style="width: 814px; font-size: large">
